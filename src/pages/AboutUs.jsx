  ...
  return (
    <section className="py-20 how-works">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Company Overview */}
        <div className="how-works backdrop-blur-lg rounded-2xl p-8 mb-10 shadow-lg border border-white/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          <div className="how-works backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 cursor-pointer sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="how-works backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20 flex flex-col items-center">
              <img
